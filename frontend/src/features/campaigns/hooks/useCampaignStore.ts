 ...
 * Strategy Interface
 * 
 * Defines the structure for Strategy.
 */
export interface Strategy {
  ...
  reasoning: string;
  summary?: string;
  steps?: { channel: string; content?: any; description?: string }[];
}

/**
 * AudienceResult Interface
 * 
 * Defines the structure for AudienceResult.
 */
...
/**
 * CityInsight Interface
 * 
 * Defines the structure for CityInsight.
 */
 ...
 * Insights Interface
 * 
 * Defines the structure for Insights.
 */
...
/**
 * ChannelContent Interface
 * 
 * Defines the structure for ChannelContent.
 */
...
/**
 * SimulatorEvent Interface
 * 
 * Defines the structure for SimulatorEvent.
 */
...
/**
 * useCampaignStore Zustand Store
 * 
 * Manages global state for CampaignStore.
 */
